...
function Stat({ label, value }: { label: string; value: React.ReactNode }) {
	return (
		<div className="min-w-0 flex-1 border-r border-(--line) px-4.5 first:pl-0 last:border-r-0 last:pr-0">
			<div className="font-mono text-[10px] tracking-[0.08em] text-(--ink-muted) uppercase">
				{label}
			</div>
			<div className="mt-1 font-mono text-[18px] text-(--ink) tabular-nums tracking-[-0.02em]">
				{value}
			</div>
		</div>
	);
